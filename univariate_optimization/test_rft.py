...
if __name__ == "__main__":
    ...
    for i, problem in enumerate(problems):
        ...
        visualization(f=f, xn=results[1], fxn=results[2], problem=str(i+1), type='newtons')
        #secant method
        results = secant_method(f=f, x0=10, x1=random.randrange(9,10), epsilon=1e-10, max_iter=10000)
        visualization(f=f, xn=results[1], fxn=results[2], problem=str(i+1), type='secant')
        ...
        visualization(f=f, xn=results[1], fxn=results[2], problem=str(i+1), type='regular_falsi')
        #bisection method
        if i == 1:
        ...
        visualization(f=f, xn=results[1], fxn=results[2], problem=str(i+1), type='bisection')
        
    print("Problem 4")
    f, df = problem4()
    #secant method
    results = secant_method(f=f, x0=5, x1=random.randrange(4,5), epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='secant')
    #regular falsi method
    results = regular_falsi_method(f=f, a=-1, b=5, epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='regular_falsi_1_', range=2)
    results = regular_falsi_method(f=f, a=-2, b=5, epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='regular_falsi_2_', range=2)
    results = regular_falsi_method(f=f, a=-3, b=5, epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='regular_falsi_3_', range=2)
    results = regular_falsi_method(f=f, a=-4, b=5, epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='regular_falsi_4_', range=2)
    results = regular_falsi_method(f=f, a=-5, b=5, epsilon=1e-10, max_iter=10000)
    visualization(f=f, xn=results[1], fxn=results[2], problem=str(4), type='regular_falsi_5_', range=2)
